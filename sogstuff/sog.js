...
function cycleRudder() {
  ...
  function cycleCurrentActions() {
    if (currentActions == "nill"){
      document.getElementById("cyclingCurrentActions").innerHTML = 'Crew is busy repairing';
      return currentActions = "repair";
    } else if (currentActions == "repair"){
      document.getElementById("cyclingCurrentActions").innerHTML = 'Crew is fighting fire';
      return currentActions = "fire";
    } else if (currentActions == "fire"){
      document.getElementById("cyclingCurrentActions").innerHTML = 'Crew is fighting fire and repairing';
      return currentActions = "fireAndRepair";
    } else if (currentActions == "fireAndRepair"){
      document.getElementById("cyclingCurrentActions").innerHTML = 'Crew is not busy from last turn';
      return currentActions = "nill"
    }
  }
...
function dist1() {
  ...
  function dist30() {
    document.getElementById("dropdownMenu1").innerHTML = 'Target Distance is 30 cm or 12 inch (or more)'
    return distance = 30;
  }
...
function computeManeuver() {
	...
	if (deltaVeer7 < veerReal) {
	    ...
	    var shallowRight1SR = {moveX:130004 ,moveY:100004, mVeer:7}
	...
	var sideslipRight1SR = {moveX:130002, moveY:100002, mVeer:5}
	var sideslipRight2SL = {moveX:-90002, moveY:160002, mVeer:5}
	...
	var sideslipLeft1SL = {moveX:-130012, moveY:100012, mVeer:5}
	...
	var Left1SL = {moveX:-130014 ,moveY:100014, mVeer:3}
	...
	var Left3FL = {moveX:-130014 ,moveY:100014, mVeer:3}
    }
  ...
  if (lowestDist == DistStraight1SL || lowestDist == DistStraight1SR || lowestDist == DistStraight2SL
    ...
    resultImageLow = '<img src="sogstuff/universalmaneuvers/straight.png" style="width:206px;height:292px;">';
    resultImageHigh = '<img src="sogstuff/universalmaneuvers/straight.png" style="width:206px;height:292px;">';
    ...
    resultImageLow = '<img src="sogstuff/universalmaneuvers/rightsideslip.png" style="width:206px;height:292px;">';
    resultImageHigh = '<img src="sogstuff/universalmaneuvers/rightsideslip.png" style="width:206px;height:292px;">';
    ...
    resultImageLow = '<img src="sogstuff/universalmaneuvers/onemastshallowright.png" style="width:206px;height:292px;">';
    resultImageHigh = '<img src="sogstuff/universalmaneuvers/onemastshallowright.png" style="width:206px;height:292px;">';
    ...
    resultImageLow = '<img src="sogstuff/universalmaneuvers/onemasttightright.png" style="width:206px;height:292px;">';
    resultImageHigh = '<img src="sogstuff/universalmaneuvers/onemasttightright.png" style="width:206px;height:292px;">';
    ...
    resultImageLow = '<img src="sogstuff/universalmaneuvers/twomastshallowright.png" style="width:206px;height:292px;">';
    resultImageHigh = '<img src="sogstuff/universalmaneuvers/twomastshallowright.png" style="width:206px;height:292px;">';
    ...
    resultImageLow = '<img src="sogstuff/universalmaneuvers/twomasttightright.png" style="width:206px;height:292px;">';
    resultImageHigh = '<img src="sogstuff/universalmaneuvers/twomasttightright.png" style="width:206px;height:292px;">';
    ...
    resultImageLow = '<img src="sogstuff/universalmaneuvers/leftsideslip.png" style="width:206px;height:292px;">';
    resultImageHigh = '<img src="sogstuff/universalmaneuvers/leftsideslip.png" style="width:206px;height:292px;">';
    ...
    resultImageLow = '<img src="sogstuff/universalmaneuvers/onemastshallowleft.png" style="width:206px;height:292px;">';
    resultImageHigh = '<img src="sogstuff/universalmaneuvers/onemastshallowleft.png" style="width:206px;height:292px;">';
    ...
    resultImageLow = '<img src="sogstuff/universalmaneuvers/onemasttightleft.png" style="width:206px;height:292px;">';
    resultImageHigh = '<img src="sogstuff/universalmaneuvers/onemasttightleft.png" style="width:206px;height:292px;">';
    ...
    resultImageLow = '<img src="sogstuff/universalmaneuvers/twomastshallowleft.png" style="width:206px;height:292px;">';
    resultImageHigh = '<img src="sogstuff/universalmaneuvers/twomastshallowleft.png" style="width:206px;height:292px;">';
    ...
    resultImageLow = '<img src="sogstuff/universalmaneuvers/twomasttightleft.png" style="width:206px;height:292px;">';
    resultImageHigh = '<img src="sogstuff/universalmaneuvers/twomasttightleft.png" style="width:206px;height:292px;">';
    ...
    if (secondLowestDist == DistStraight1SL || secondLowestDist == DistStraight1SR || secondLowestDist == DistStraight2SL
      || secondLowestDist == DistStraight2SR || secondLowestDist == DistStraight3SL || secondLowestDist == DistStraight3SR
      || secondLowestDist == DistStraight1FL || secondLowestDist == DistStraight1FR || secondLowestDist == DistStraight2FL
      || secondLowestDist == DistStraight2FR || secondLowestDist == DistStraight3FL|| secondLowestDist == DistStraight3FR) {
    result2 = "Use a straight maneuver card";
    resultLow2 = "Use a straight maneuver card (veer 5)";
    resultHigh2 = "Use a straight maneuver card (veer 5)";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/straight.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/straight.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistSideslipRight1SL || secondLowestDist == DistSideslipRight1SR || secondLowestDist == DistSideslipRight2SL
      || secondLowestDist == DistSideslipRight2SR || secondLowestDist == DistSideslipRight3SL || secondLowestDist == DistSideslipRight3SR
      || secondLowestDist == DistSideslipRight1FL || secondLowestDist == DistSideslipRight1FR || secondLowestDist == DistSideslipRight2FL
      || secondLowestDist == DistSideslipRight2FR || secondLowestDist == DistSideslipRight3FL || secondLowestDist == DistSideslipRight3FR){
    result2 = "Use the right sideslip maneuver card";
    resultLow2 = "Use a right sideslip card (veer 5)";
    resultHigh2 = "Use a right sideslip card (veer 5)";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/rightsideslip.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/rightsideslip.png" style="width:206px;height:292px;">';
     } else if (secondLowestDist == DistShallowestRight1SL || secondLowestDist == DistShallowestRight1SR || secondLowestDist == DistShallowestRight2SL
      || secondLowestDist == DistShallowestRight2SR || secondLowestDist == DistShallowestRight3SL || secondLowestDist == DistShallowestRight3SR
      || secondLowestDist == DistShallowestRight1FL || secondLowestDist == DistShallowestRight1FR || secondLowestDist == DistShallowestRight2FL
      || secondLowestDist == DistShallowestRight2FR || secondLowestDist == DistShallowestRight3FL || secondLowestDist == DistShallowestRight3FR){
    result2 = "Use the shallowst right maneuver card available";
    resultLow2 = "Use a right maneuver card (veer 6)";
    resultHigh2 = "Use a right maneuver card (veer 6)";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/right6.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/right6.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistShallowRight1SL || secondLowestDist == DistShallowRight1SR || secondLowestDist == DistShallowRight2SL || secondLowestDist == DistShallowRight2SR 
      || secondLowestDist == DistShallowRight3SL || secondLowestDist == DistShallowRight3SR || secondLowestDist == DistShallowRight1FL
      || secondLowestDist == DistShallowRight1FR || secondLowestDist == DistShallowRight2FL || secondLowestDist == DistShallowRight2FR
      || secondLowestDist == DistShallowRight3FL || secondLowestDist == DistShallowRight3FR){
    result2 = "Use a shallow right maneuver card";
    resultLow2 = "Use a right maneuver card (veer 7)";
    resultHigh2 = "Use a right maneuver card (veer 6)";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/right7.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/right6.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistRight1SL || secondLowestDist == DistRight1SR || secondLowestDist == DistRight2SL
      || secondLowestDist == DistRight2SR || secondLowestDist == DistRight3SL || secondLowestDist == DistRight3SR
      || secondLowestDist == DistRight1FL || secondLowestDist == DistRight1FR || secondLowestDist == DistRight2FL
      || secondLowestDist == DistRight2FR || secondLowestDist == DistRight3FL || secondLowestDist == DistRight3FR){
    result2 = "Use a standard right maneuver card ";
    resultLow2 = "Use a right maneuver card (veer 8)";
    resultHigh2 = "Use a right maneuver card (veer 7)";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/right8.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/right7.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistTightRight1SL || secondLowestDist == DistTightRight1SR || secondLowestDist == DistTightRight2SL
      || secondLowestDist == DistTightRight2SR || secondLowestDist == DistTightRight3SL || secondLowestDist == DistTightRight3SR
      || secondLowestDist == DistTightRight1FL || secondLowestDist == DistTightRight1FR || secondLowestDist == DistTightRight2FL
      || secondLowestDist == DistTightRight2FR || secondLowestDist == DistTightRight3FL || secondLowestDist == DistTightRight3FR){
    result2 = "Use a tight right maneuver card";
    resultLow2 = "Use a right maneuver card (veer 9)";
    resultHigh2 = "Use a right maneuver card (veer 8)";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/right9.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/right8.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistTightestRight1SL || secondLowestDist == DistTightestRight1SR || secondLowestDist == DistTightestRight2SL
      || secondLowestDist == DistTightestRight2SR || secondLowestDist == DistTightestRight3SL || secondLowestDist == DistTightestRight3SR
      || secondLowestDist == DistTightestRight1FL || secondLowestDist == DistTightestRight1FR || secondLowestDist == DistTightestRight2FL
      || secondLowestDist == DistTightestRight2FR || secondLowestDist == DistTightestRight3FL || secondLowestDist == DistTightestRight3FR){
    result2 = "Use the tightest right maneuver card";
    resultLow2 = "Use a right maneuver card (veer 10)";
    resultHigh2 = "Use a right maneuver card (veer 8)";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/right10.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/right8.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistOneMastShallowRightSL || secondLowestDist == DistOneMastShallowRightSR || secondLowestDist == DistOneMastShallowRightFL
      || secondLowestDist == DistOneMastShallowRightFR){
    result2 = "Use a shallow right maneuver card for one mast broken";
    resultLow2 = "Use a shallow right maneuver card for one mast broken";
    resultHigh2 = "Use a shallow right maneuver card for one mast broken";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/onemastshallowright.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/onemastshallowright.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistOneMastTightRightSR || secondLowestDist == DistOneMastTightRightFL
	|| secondLowestDist == DistOneMastTightRightFR){
    result2 = "Use a tight right maneuver card for one mast broken";
    resultLow2 = "Use a tight right maneuver card for one mast broken";
    resultHigh2 = "Use a tight right maneuver card for one mast broken";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/onemasttightright.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/onemasttightright.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistTwoMastShallowRightSL || secondLowestDist == DistTwoMastShallowRightSR || secondLowestDist == DistTwoMastShallowRightFL
      || secondLowestDist == DistTwoMastShallowRightFR){
    result2 = "Use a shallow right maneuver card for two masts broken ";
    resultLow2 = "Use a shallow right maneuver card for two masts broken ";
    resultHigh2 = "Use a shallow right maneuver card for two masts broken ";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/twomastshallowright.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/twomastshallowright.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistTwoMastTightRightSL || secondLowestDist == DistTwoMastTightRightSR || secondLowestDist == DistTwoMastTightRightFL
      || secondLowestDist == DistTwoMastTightRightFR ){
    result2 = "Use a tight right maneuver card for two masts broken";
    resultLow2 = "Use a tight right maneuver card for two masts broken";
    resultHigh2 = "Use a tight right maneuver card for two masts broken";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/twomasttightright.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/twomasttightright.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistRedStraight1L || secondLowestDist == DistRedStraight1R){
    result2 = "Use a (first) red straight maneuver card";
    resultLow2 = "Use a (first) red straight maneuver card";
    resultHigh2 = "Use a (first) red straight maneuver card";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/redstraight.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/redstraight.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistRedStraight2L
      || secondLowestDist == DistRedStraight2R){
    result2 = "Use a (second) red straight maneuver card";
    resultLow2 = "Use a (second) red straight maneuver card";
    resultHigh2 = "Use a (second) red straight maneuver card";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/redstraight.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/redstraight.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistRedRight1L || secondLowestDist == DistRedRight1R){
    result2 = "Use a (first) red right maneuver card";
    resultLow2 = "Use a (first) red right maneuver card";
    resultHigh2 = "Use a (first) red right maneuver card";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/redright.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/redright.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistRedRight2L || secondLowestDist == DistRedRight2R){
    result2 = "Use a (second) red right maneuver card";
    resultLow2 = "Use a (second) red right maneuver card";
    resultHigh2 = "Use a (second) red right maneuver card";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/redright.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/redright.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistSideslipLeft1SR || secondLowestDist == DistSideslipLeft1SL || secondLowestDist == DistSideslipLeft3FL
      || secondLowestDist == DistSideslipLeft2SR || secondLowestDist == DistSideslipLeft2SL || secondLowestDist == DistSideslipLeft3SR
      || secondLowestDist == DistSideslipLeft3SL || secondLowestDist == DistSideslipLeft1FR || secondLowestDist == DistSideslipLeft1FL
      || secondLowestDist == DistSideslipLeft2FR || secondLowestDist == DistSideslipLeft2FL || secondLowestDist == DistSideslipLeft3FR){
    result2 = "Use a left sideslip maneuver card";
    resultLow2 = "Use a left sideslip maneuver card (veer 5)";
    resultHigh2 = "Use a left sideslip maneuver card (veer 5)";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/leftsideslip.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/leftsideslip.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistShallowestLeft1SR || secondLowestDist == DistShallowestLeft1SL || secondLowestDist == DistShallowestLeft2SR
      || secondLowestDist == DistShallowestLeft2SL || secondLowestDist == DistShallowestLeft3SR || secondLowestDist == DistShallowestLeft3SL
      || secondLowestDist == DistShallowestLeft1FR || secondLowestDist == DistShallowestLeft1FL || secondLowestDist == DistShallowestLeft2FR
      || secondLowestDist == DistShallowestLeft2FL || secondLowestDist == DistShallowestLeft3FR || secondLowestDist == DistShallowestLeft3FL){
    result2 = "Use the shallowest left maneuver card";
    resultLow2 = "Use a left maneuver card (veer 4)";
    resultHigh2 = "Use a left maneuver card (veer 4)";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/left4.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/left4.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistShallowLeft1SR || secondLowestDist == DistShallowLeft1SL || secondLowestDist == DistShallowLeft2SR
      || secondLowestDist == DistShallowLeft2SL || secondLowestDist == DistShallowLeft3SR || secondLowestDist == DistShallowLeft3SL
      || secondLowestDist == DistShallowLeft1FR || secondLowestDist == DistShallowLeft1FL || secondLowestDist == DistShallowLeft2FR
      || secondLowestDist == DistShallowLeft2FL || secondLowestDist == DistShallowLeft3FR || secondLowestDist == DistShallowLeft3FL){
    result2 = "Use a shallow left maneuver card";
    resultLow2 = "Use a left maneuver card (veer 3)";
    resultHigh2 = "Use a left maneuver card (veer 4)";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/left3.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/left4.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistLeft1SR || secondLowestDist == DistLeft1SL || secondLowestDist == DistLeft2SR
      || secondLowestDist == DistLeft2SL || secondLowestDist == DistLeft3SR || secondLowestDist == DistLeft3SL
      || secondLowestDist == DistLeft1FR || secondLowestDist == DistLeft1FL || secondLowestDist == DistLeft2FR
      || secondLowestDist == DistLeft2FL || secondLowestDist == DistLeft3FR || secondLowestDist == DistLeft3FL){
    result2 = "Use a normal left maneuver card";
    resultLow2 = "Use a left maneuver card (veer 2)";
    resultHigh2 = "Use a left maneuver card (veer 3)";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/left2.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/left3.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistTightLeft1SR || secondLowestDist == DistTightLeft1SL || secondLowestDist == DistTightLeft2SR
      || secondLowestDist == DistTightLeft2SL || secondLowestDist == DistTightLeft3SR || secondLowestDist == DistTightLeft3SL
      || secondLowestDist == DistTightLeft1FR || secondLowestDist == DistTightLeft1FL || secondLowestDist == DistTightLeft2FR
      || secondLowestDist == DistTightLeft2FL || secondLowestDist == DistTightLeft3FR || secondLowestDist == DistTightLeft3FL){
    result2 = "Use a tight left maneuver card";
    resultLow2 = "Use a left maneuver card (veer 1)";
    resultHigh2 = "Use a left maneuver card (veer 2)";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/left1.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/left2.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistTightestLeft1SR || secondLowestDist == DistTightestLeft1SL || secondLowestDist == DistTightestLeft2SR
      || secondLowestDist == DistTightestLeft2SL || secondLowestDist == DistTightestLeft3SR || secondLowestDist == DistTightestLeft3SL
      || secondLowestDist == DistTightestLeft1FR || secondLowestDist == DistTightestLeft1FL || secondLowestDist == DistTightestLeft2FR
      || secondLowestDist == DistTightestLeft2FL || secondLowestDist == DistTightestLeft3FR || secondLowestDist == DistTightestLeft3FL){
    result2 = "Use the tightest left maneuver card";
    resultLow2 = "Use a left maneuver card (veer 0)";
    resultHigh2 = "Use a left maneuver card (veer 2)";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/left0.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/left2.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistOneMastShallowLeftSR || secondLowestDist == DistOneMastShallowLeftSL || secondLowestDist == DistOneMastShallowLeftFR
      || secondLowestDist == DistOneMastShallowLeftFL){
    result2 = "Use a shallow left maneuver card for one mast broken";
    resultLow2 = "Use a shallow left maneuver card for one mast broken";
    resultHigh2 = "Use a shallow left maneuver card for one mast broken";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/onemastshallowleft.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/onemastshallowleft.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistOneMastTightLeftSR || secondLowestDist == DistOneMastTightLeftSL || secondLowestDist == DistOneMastTightLeftFR
      || secondLowestDist == DistOneMastTightLeftFL){
    result2 = "Use a tight left maneuver card for one mast broken";
    resultLow2 = "Use a tight left maneuver card for one mast broken";
    resultHigh2 = "Use a tight left maneuver card for one mast broken";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/onemasttightleft.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/onemasttightleft.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistTwoMastShallowLeftSR || secondLowestDist == DistTwoMastShallowLeftSL || secondLowestDist == DistTwoMastShallowLeftFR
      || secondLowestDist == DistTwoMastShallowLeftFL){
    result2 = "Use a shallow left maneuver card for two masts broken";
    resultLow2 = "Use a shallow left maneuver card for two masts broken";
    resultHigh2 = "Use a shallow left maneuver card for two masts broken";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/twomastshallowleft.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/twomastshallowleft.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistTwoMastTightLeftSR || secondLowestDist == DistTwoMastTightLeftSL || secondLowestDist == DistTwoMastTightLeftFR
      || secondLowestDist == DistTwoMastTightLeftFL){
    result2 = "Use a tight left maneuver card for two masts broken";
    resultLow2 = "Use a tight left maneuver card for two masts broken";
    resultHigh2 = "Use a tight left maneuver card for two masts broken";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/twomasttightleft.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/twomasttightleft.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistRedLeft1R || secondLowestDist == DistRedLeft1L){
    result2 = "Use a (first) red left maneuver card";
    resultLow2 = "Use a (first) red left maneuver card";
    resultHigh2 = "Use a (first) red left maneuver card";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/redleft.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/redleft.png" style="width:206px;height:292px;">';
    } else if (secondLowestDist == DistRedLeft2R || secondLowestDist == DistRedLeft2L){
    result2 = "Use a (second) red left maneuver card";
    resultLow2 = "Use a (second) red left maneuver card";
    resultHigh2 = "Use a (second) red left maneuver card";
    resultImageLow2 = '<img src="sogstuff/universalmaneuvers/redleft.png" style="width:206px;height:292px;">';
    resultImageHigh2 = '<img src="sogstuff/universalmaneuvers/redleft.png" style="width:206px;height:292px;">';
    }
    ...
    var resultRoll = Math.floor((Math.random() * 2) + 1);
    
    var resultFinal;
    var resultImageFinal;
    if (deck == "low" && resultRoll == 1) {
	resultFinal = resultLow;
	resultImageFinal = resultImageLow;
    } else if (deck == "low" && resultRoll == 2) {
	resultFinal = resultLow2;
	resultImageFinal = resultImageLow2;
    } else if (deck == "high" && resultRoll == 1) {
	resultFinal = resultHigh;
	resultImageFinal = resultImageHigh;
    } else if (deck == "high" && resultRoll == 2) {
	resultFinal = resultHigh2;
	resultImageFinal = resultImageHigh2;
    }
      ...
      //document.getElementById("debug1").innerHTML = crewNReal;
...
function computeCrewAction() {
    ...
    if (currentActions == "nill") {
      ...
      var crewNReal = crewN - 1;
    } else if (currentActions == "fire"){
      var crewNReal = crewN - 1;
    } else if (currentActions == "fireAndRepair"){
      var crewNReal = crewN - 2;
    }
    
var crewActions = [];

var currentRepairType = "nill"
...
if (distance == 30 && sailN != "full" && sail < 2 || distance == 25 && sailN == "backing" && sail < 4) {
...
if (cannons == "both" && targetX < 0 && distance < 30 || cannons == "port" && targetX < 0 && distance < 30 || otherTargets == 2 || otherTargets == 3) {
    crewActions.push(firePort);
}

if (cannons == "both" && targetX > 0 && distance < 30 || cannons == "starboard" && targetX > 0 && distance < 30 || otherTargets == 1 || otherTargets == 3) {
...
if (fire == "yes" && currentActions != "fireAndRepair" && currentActions != "fire") {
    crewActions.push(extFire);
}

if (leak == "yes" && currentActions != "repair" && currentActions != "fireAndRepair") {
    crewActions.push(repairLeak);
    currentRepairType = "leak";
}

if (prevRepair == "none" && damage == 1 && currentActions != "fireAndRepair" && currentActions != "repair" && currentRepairType != "leak" ||
    prevRepair == "mast" && currentRepairType != "leak" && damage == 1 && currentActions != "fireAndRepair" && currentActions != "repair") {
    crewActions.push(repairDamage);
    currentRepairType = "damage";
}


if (prevRepair == "none" && mast >= 1 && mast < 3 && currentActions != "repair" && currentActions != "fireAndRepair" && currentRepairType != "leak" && currentRepairType != "damage" ||
    prevRepair == "normal" && mast >= 1 && mast < 3 && currentActions != "repair" && currentActions != "fireAndRepair" && currentRepairType != "leak"  && currentRepairType != "damage") {
    crewActions.push(repairMast);
    currentRepairType = "mast";
}

if (rudderDamage == 1 && currentActions != "repair" && currentRepairType == "nill" || rudderDamage == 1 && currentActions != "fireAndRepair" && currentRepairType == "nill") {
    crewActions.push(repairRudder);
    currentRepairType = "rudder";
}
...
var crewActionsLength =  crewActions.length;
    ...
    crewActions.sort(function(a, b){return a.priority - b.priority});
     ...
     if (crewNReal == 4 && crewActionsLength > 3) {
	var resultshownCrew = '<div class="alert alert-success text-center">'+ crewActions[0].action + ", " + crewActions[1].action + ", " + crewActions[2].action + ", " + crewActions[3].action + '</div>'
     } else if (crewNReal == 3 && crewActionsLength > 2 || crewNReal == 4 && crewActionsLength == 3) {
	var resultshownCrew = '<div class="alert alert-success text-center">'+ crewActions[0].action + ", " + crewActions[1].action + ", " + crewActions[2].action + '</div>'
     } else if (crewNReal == 2 && crewActionsLength > 1 || crewNReal == 3 && crewActionsLength == 2 || crewNReal == 4 && crewActionsLength == 2) {
	var resultshownCrew = '<div class="alert alert-success text-center">'+ crewActions[0].action + ", " + crewActions[1].action + '</div>'
     } else if (crewNReal == 1 || crewNReal == 2 && crewActionsLength == 1 || crewNReal == 3 && crewActionsLength == 1 || crewNReal == 4 && crewActionsLength == 1) {
...
function updateStats(){
  ...
  if (prevVeer == 1) {
    ...
    if (currentActions == "repair"){
      document.getElementById("cyclingCurrentActions").innerHTML = 'Crew is busy repairing';
    } else if (currentActions == "fire"){
      document.getElementById("cyclingCurrentActions").innerHTML = 'Crew is fighting fire';
    } else if (currentActions == "fireAndRepair"){
      document.getElementById("cyclingCurrentActions").innerHTML = 'Crew is fighting fire and repairing';
    } else if (currentActions == "nill"){
      document.getElementById("cyclingCurrentActions").innerHTML = 'Crew is not busy from last turn';
    }
...
function setShip1() {
	...
	currentActionsA = currentActions
	...
	currentActionsB = currentActions
	...
	currentActionsC = currentActions
	...
	currentActionsD = currentActions
    }
    ...
    currentActions = currentActionsA
...
function setShip2() {
    ...
    currentActions = currentActionsB
...
function setShip3() {
    ...
    currentActions = currentActionsC
...
function setShip4() {
    ...
    currentActions = currentActionsD
